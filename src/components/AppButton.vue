<template>
  <div class="button" :class="{'big': big, 'drag': type === 'drag'}" @click="$emit('click')">
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24">
      <path v-if="type === 'add'"
            d="M13 11h-2v3H8v2h3v3h2v-3h3v-2h-3zm1-9H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"></path>
      <path v-if="type === 'edit'" xmlns="http://www.w3.org/2000/svg"
      ...
      <path v-if="type === 'drag'" xmlns="http://www.w3.org/2000/svg"
      ...
      <path v-if="type === 'color'" xmlns="http://www.w3.org/2000/svg"
      ...
      <path v-if="type === 'image'" xmlns="http://www.w3.org/2000/svg"
      ...
      <path v-if="type === 'save'"
            xmlns="http://www.w3.org/2000/svg" d="M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z"></path>
